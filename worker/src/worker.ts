	...
	async fetch(request: Request, env: Env, ctx: ExecutionContext): Promise<Response> {
		...
		if (!method) {
			return WorkerResponse({
				...
				ep: 'EPIsode ID',
				example: {
					"SEARCH-ANIME": 'https://anicoveapi.shawnmwask1234.workers.dev/?method=search&query=Words',
					"FETCH-EPISODE-OF-A-SERIES": "https://anicoveapi.shawnmwask1234.workers.dev/?method=series&session=5fe211d4-3cef-c32a-ab31-ec777f07fc5f&page=1",
					"REQUEST-LINKS-OF-A-EPISODE": "https://anicoveapi.shawnmwask1234.workers.dev/?method=episode&session=5fe211d4-3cef-c32a-ab31-ec777f07fc5f&ep=52f935732970bc1e1482d7e726b34fba1ffdbe040a55f9c9c03cfa0a20dff6ea"
				}
			}, 'application/json')
		}
